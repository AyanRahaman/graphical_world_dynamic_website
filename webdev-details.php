        ...
        <article class="blog-post shadow p-3 bg-white">
          ...
          <div class="our_services">
            <div class="row">
              <div class="col-lg-4">
                          <?php
                                $sql2 = "SELECT * FROM s_services WHERE type ='Website Development'";
          ...
          <ul class="list-unstyled">
                              <?php
                                $sql3= "SELECT * FROM s_s_c_project WHERE type ='Website Development'";
        ...
        <div class="position-sticky mt-5" style="top: 2rem">
            ...
            <?php
              ...
              <li>
                <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                  href="portfolio">
                  <img class="bd-placeholder-img" src="dashboard/images/<?php echo $portfolio_image; ?>" width="100%" height="96" alt="<?php echo $image; ?>">
                  <div class="col-lg-8">
          ...
          <div class="p-4">
            ...
            <ol class="list-unstyled" style="display: flex">
              ...
              <li class="m-2 border bg-dark border-black shadow px-3 py-2 rounded-circle">
                <a class="text-decoration-none text-white" href="<?php echo $whatsapp; ?>" target="_blank" target="_blank"><i class="fab fa-whatsapp"></i></a>
              </li>
              <li class="m-2 border bg-dark border-black shadow px-3 py-2 rounded-circle">
