...
<div class="container mt-5 col-lg-4 border border-dark p-3">
    <h5 class="fw-bold text-center text-primary">Home Page Image Slider Change</h5><hr>
<form action="" method="post" enctype="multipart/form-data">
  ...
  <?php
    ...
    <label for="image" class="form-label"><span class="fw-bold">Change Image</span>(image size must be 1500x600 px)</label>
...
<?php
                    ...
                    if($result){
                        echo "<script>alert('Succesfully Updated!!');document.location='settings.php'</script>";
                    }
                    else{
                        echo"
                        <script>
