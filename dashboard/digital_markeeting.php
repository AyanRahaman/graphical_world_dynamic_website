...
<div class="col-md-12 col-lg-12 p-4">
                        <div class="p-3 border border-dark bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h4 class="card-title m-0 fw-bold fst-italic text-success">Digital Markeeting</h4>
                            ...
                            <?php
                              ...
                              if (isset($_POST["digital_markeeting"])) {
                                  ...
                                  if(!empty($_POST["about"])){
                                    ...
                                    $query3 = "UPDATE s_content SET about = '$about'  WHERE type = 'Digital Markeeting'";
                              
                                    $result3 = $connectingDB->query($query3);
                              
                                    if($result3){
                                echo "<script>alert('Data succesfully updated!!');document.location='digital_markeeting.php'</script>";
                                  }
                                  else{
                                    echo "<script>alert('Data not updated!! Something went wrong');document.location='digital_markeeting.php'</script>";
                    ...
                    <form id="general_s_form" action="" method="post">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Digital Markeeting</h5>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="digital_markeeting" class="btn btn-dark text-white shadow-none">
                                    Submit
                                </button>
                            </div>
                        </div>
    ...
    <!-- === //DIGITAL MARKEETING IMAGE START// === -->
<div class="col-md-12 col-lg-12 p-4">
                        <div class="p-3 border border-dark bg-white shadow-sm justify-content-around align-items-center rounded">   
                    <h4 class="card-title mb-3 mt-3 fw-bold fst-italic text-success">Image(Digital Markeeting)</h4><hr>
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                                <?php
                                require_once("partials/DBconnect.php");
                                $sql3 = "SELECT * FROM s_content WHERE id = 3";
                                ...
                                <div class="col-lg-4">
                                  <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                    <a href=" d_m_image.php?id=<?php echo $id; ?>">
...
<!-- === //DIGITAL MARKEETING IMAGE END// === -->
 ...
 <div class="col-md-12 col-lg-12 p-4">
                <div
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h4 class="card-title m-0 fw-bold fst-italic text-success">Services (Digital Markeerting)</h4>
                            <!-- ==Button trigger modal== -->
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    // require_once("partials/DBconnect.php");
                                    $sql5 = "SELECT * FROM s_services WHERE type = 'Digital Markeeting' ORDER BY id DESC";
                                    ...
                                    while ($Data5 = $stmt5->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $type; ?></td>
                                            <td><a
                                                    href="digital_m_services_delete.php?id=<?php echo $id; ?>"><button
                            ...
                            <form id="general_s_form" action="" method="post">
                                ...
                                if (isset($_POST["s_services"])) {
                                    ...
                                    if (!empty($_POST["s_s_name"]) && !empty($_POST["type"])) {
                                        ...
                                        if ($result6) {
                                            echo "<script>alert('Data succesfully inserted!');document.location='digital_markeeting.php'</script>";
                                        } else {
                                            echo "<script>alert('Data not inserted!!');document.location='digital_markeeting.php'</script>";
                                        }
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Services (Digital Markeeting)</h5>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
...
<div class="col-md-12 col-lg-12 p-4">
                <div
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h4 class="card-title m-0 fw-bold fst-italic text-success">Project (Digital Markeerting)</h4>
                            <!-- ==Button trigger modal== -->
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    // require_once("partials/DBconnect.php");
                                    $sql7 = "SELECT * FROM s_s_c_project WHERE type = 'Digital Markeeting' ORDER BY id DESC";
                                    ...
                                    while ($Data7 = $stmt7->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="digital_m_project_delete.php?id=<?php echo $id; ?>"><button
                                                        class="btn btn-danger shadow-none">Delete</button></a></td>
                    ...
                    <div class="modal fade" id="general-p" data-bs-backdrop="static" data-bs-keyboard="true"
                        ...
                        <div class="modal-dialog">
                            <form id="general_s_form" action="" method="post">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Project (Digital Markeeting)</h5>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Name</label>
