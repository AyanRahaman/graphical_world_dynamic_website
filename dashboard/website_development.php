                            ...
                            <?php
                              ...
                              if (isset($_POST["website_development"])) {
                                  ...
                                  if(!empty($_POST["about"])){
                                    ...
                                    $query3 = "UPDATE s_content SET about = '$about'WHERE id=2";
...
<div class="col-md-12 col-lg-12">
                    ...
                    <h4 class="card-title mb-3 mt-3 fw-bold fst-italic text-success">Image (Website Development)</h4><hr>
...
<!-- === //WEBSITE DEVELOPMENT IMAGE END// === --> 
 ...
 <div class="col-md-12 col-lg-12">
                <div
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h4 class="card-title m-0 fw-bold fst-italic text-success">Services (Website Development)</h4>
                            <!-- ==Button trigger modal== -->
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    // require_once("partials/DBconnect.php");
                                    $sql5 = "SELECT * FROM s_services WHERE type = 'Website Development' ORDER BY id DESC";
                                    ...
                                    while ($Data5 = $stmt5->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $type; ?></td>
                                            <td><a
                                                    href="webdev_services_delete.php?id=<?php echo $id; ?>"><button
                            ...
                            <form id="general_s_form" action="" method="post">
                                ...
                                if (isset($_POST["s_services"])) {
                                    ...
                                    if (!empty($_POST["s_s_name"]) && !empty($_POST["type"])) {
                                        ...
                                        if ($result6) {
                                            echo "<script>alert('Data succesfully inserted!');document.location='website_development.php'</script>";
                                        } else {
                                            echo "<script>alert('Data not inserted!!');document.location='website_development.php'</script>";
                                        }
...
<div class="col-md-12 col-lg-12">
                <div
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h4 class="card-title m-0 fw-bold fst-italic text-success">Project (Website Development)</h4>
                            <!-- ==Button trigger modal== -->
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    // require_once("partials/DBconnect.php");
                                    $sql7 = "SELECT * FROM s_s_c_project WHERE type = 'Website Development' ORDER BY id DESC";
                                    ...
                                    while ($Data7 = $stmt7->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="webdev_project_delete.php?id=<?php echo $id; ?>"><button
                                                        class="btn btn-danger shadow-none">Delete</button></a></td>
                    ...
                    <div class="modal fade" id="general-p" data-bs-backdrop="static" data-bs-keyboard="true"
                        ...
                        <div class="modal-dialog">
                            <form id="general_s_form" action="" method="post">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Project (Website Development)</h5>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Name</label>
