...
<div class="container mt-5 col-lg-4 border border-dark p-3">
    <h5 class="fw-bold text-center text-primary">Wedding Photography Service Image</h5><hr>
...
<?php
                    ...
                    if($result){
                        echo "<script>alert('Succesfully Updated!!');document.location='wedding_photography.php'</script>";
                    }
                    else{
                        echo"
                        <script>
