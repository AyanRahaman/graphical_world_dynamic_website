      ...
      <div class="col-md-8">
        ...
        <article class="blog-post shadow p-3 bg-white">
          ...
          <table class="table">
            <tbody>
              <tr>
                <td colspan="2">Logo Design</td>
                <td>₹100</td>
              </tr>
              <tr>
                <td colspan="2">Stickers Design</td>
                <td>₹100</td>
              </tr>
              <tr>
                <td colspan="2">Banner Design</td>
                <td>₹100</td>
              </tr>
              <tr>
                <td colspan="2">Business Card</td>
                <td>₹100</td>
              </tr>
            </tbody>
          </table>          
      ...
      <div class="col-md-4 shadow bg-white">
        <div class="position-sticky" style="top: 2rem">
          <div class="p-4 mb-3 bg-body-tertiary rounded">
            ...
            <p class="mb-0">
              Our graphic design services cover a wide range of products –
              brochures, business cards, publications, mailers, posters and
              billboards – we’ve pretty much designed it all. With nearly 6
              years of experience designing for print and the web, we’ll help
              your business convert potential clients into paying customers
              with well designed, printed collateral.
            </p>
          </div>
          <div>
            <h4 class="fst-italic">
